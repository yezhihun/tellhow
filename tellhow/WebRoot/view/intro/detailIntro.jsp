  ...
  <body>
  	<div id="query">
	  	<table>
	  		<tr>
	  			<td><span>标题</span><td>
	  			<td><input name="intro.title" value="${intro.title}" type="text"> <td> 
	  		</tr>
	  		<tr>
	  			<td><span>简介</span><td>
	  			<td><textarea rows="20" cols="50" name="intro.info">${intro.info}</textarea> <input name="intro.id" value="${intro.id}" type="text" style="display: none;" > <td> 
	  		</tr>
	  	</table>
  	</div>
