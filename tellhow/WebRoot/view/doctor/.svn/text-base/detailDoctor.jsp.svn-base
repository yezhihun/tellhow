  ...
  <body>
  	<div id="query">
	  	<table>
	  		<tr>
	  			<td><span>姓名</span><td>
	  			<td> <input type="text" name="doctor.name" value="${doctor.name}"> <input name="doctor.id" value="${doctor.id}" type="text" style="display: none;" > <td> 
	  		</tr>
	  		<tr>
	  			<td><span>性别</span><td>
	  			<td> 
	  		...
	  		<tr>
	  			<td><span>年龄</span><td>
	  			<td> <input type="text" name="doctor.age" value="${doctor.age}"> <td> 
	  		</tr>
	  		<tr>
	  			<td><span>级别</span><td>
	  			<td> 
	  			<select id="lev" name="doctor.level.id">
	  		...
	  		<tr>
	  			<td><span>科室</span><td>
	  			<td>
	  			<select id="dep" name="doctor.depart.id">
