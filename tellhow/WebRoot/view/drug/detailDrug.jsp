  	...
  	<div id="query">
	  	<table>
	  		<tr>
	  			...
	  			<td> <input type="text" name="drug.name" value="${drug.name}"> <input name="drug.id" value="${drug.id}" type="text" style="display: none;" > <td> 
	  		</tr>
	  		<tr>
	  			<td><span>描述</span><td>
	  			<td> <input type="text" name="drug.info" value="${drug.info}"> <td> 
	  		</tr>
	  	</table>
  	</div>
